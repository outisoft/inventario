...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'home', 'description' => 'Ver home'])->syncRoles($admin, $adminRegion, $support);

        Permission::create(['name' => 'history.index', 'description' => 'Ver Historial'])->syncRoles($admin, $adminRegion, $support);
        ...
        Permission::create(['name' => 'equipment.index', 'description' => 'Ver listado de equipos'])->syncRoles($admin, $adminRegion, $support);
        Permission::create(['name' => 'equipment.show', 'description' => 'Asignar complemento a equipo'])->syncRoles($admin, $adminRegion, $support);
        ...
        Permission::create(['name' => 'employee.index', 'description' => 'Ver listado de empleados'])->syncRoles($admin, $adminRegion, $support);
        Permission::create(['name' => 'employee.show', 'description' => 'Ver detalle de empleado'])->syncRoles($admin, $adminRegion, $support);
        Permission::create(['name' => 'employee.create', 'description' => 'Registrar nuevos empleados'])->syncRoles($admin, $adminRegion, $support);
        Permission::create(['name' => 'employee.edit', 'description' => 'Editar Empleados'])->syncRoles($admin, $adminRegion, $support);
        Permission::create(['name' => 'employee.destroy', 'description' => 'Eliminar Empleados'])->syncRoles($admin, $adminRegion, $support);
        Permission::create(['name' => 'employee.assign', 'description' => 'Asignar equipo a empleados'])->syncRoles($admin, $adminRegion, $support);
        Permission::create(['name' => 'employee.details', 'description' => 'Ver detalles de asignacion'])->syncRoles($admin, $adminRegion, $support);
